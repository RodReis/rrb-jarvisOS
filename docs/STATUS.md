...
| Backlog · **next** | [#254](https://github.com/RodReis/rrb-jarvisOS/issues/254) · M26-F04 Marcos Git e gate da construção | SPEC `aprovada-pi` (2026-09-04). Painel de marcos + bloqueio no `SLICE_ENTRY` |
