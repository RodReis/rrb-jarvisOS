...
> **MVP-007 em detalhamento (2026-08-30).** Direção compartilhada, captura, identidade e persistência/retenção aprovadas; memória durável e compactação de detalhes após 30 dias. Graphify opcional, F05 focada e pipeline não dependente da memória. Próxima decisão: recuperação contextual e orçamento. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
