...
> **MVP-007 em detalhamento (2026-08-30).** Contrato de integração opcional do Graphify aprovado: adapter substituível, fontes delimitadas e reflexões candidatas. F05 focada; pipeline não depende da memória. Próxima decisão: validação das lições fora da pipeline. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
...
5. MVP-007 em detalhamento, com contrato de integração opcional do Graphify aprovado; próxima decisão: validação das lições fora da pipeline. Não há fatias ou SPECs aprovadas. MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F04 aprovados; F05–F06 aguardam redação nas #167–#168, que permanecem Planejadas.
