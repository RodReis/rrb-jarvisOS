...
> **`proplan:next` = [#18](https://github.com/RodReis/rrb-jarvisOS/issues/18)** (MVP-003 · F02 Foundations). O MVP-003 começou em 2026-07-23 pela **F01 (#17)**, entregue no mesmo dia; o marcador avançou para a cabeça da fila restante.
...
| [#18](https://github.com/RodReis/rrb-jarvisOS/issues/18) | 02 Foundations + ponte com o protótipo | M3-F02 | `spec-design-system-02-foundations.md` | Backlog · **`next`** |
| [#19](https://github.com/RodReis/rrb-jarvisOS/issues/19) | 03a Componentes: ações + formulários | M3-F03a | `spec-design-system-03a-componentes-acoes-forms.md` | Backlog |
...
| MVP-003 Design System da Plataforma (base única, 2 identidades) | [#16](https://github.com/RodReis/rrb-jarvisOS/issues/16) | **em andamento** desde 2026-07-23; F01 (#17) entregue e aguardando aceite; `next` na F02 (#18) | 0 / 8 *(1 entregue)* |
...
4. ~~**Code**: iniciar o MVP-003 pela F01 (#17)~~ — **feito** (2026-07-23): F01 entregue no PR [#38](https://github.com/RodReis/rrb-jarvisOS/pull/38). Segue com WIP = 1, na ordem F02 → (F03a/F03b/F05) → F04a → F04b → F06. **Próxima: F02 (#18)**, marcada `proplan:next`.
...
10. **PI**: aceitar a F01 (#17) — entregue no PR [#38](https://github.com/RodReis/rrb-jarvisOS/pull/38), aguardando `proplan:finalizado`.
