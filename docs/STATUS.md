...
> **`proplan:next` = [#21](https://github.com/RodReis/rrb-jarvisOS/issues/21)** (MVP-003 · F04a AppShell + navegação). F01, F02, F03a, F03b e F05 entregues em 2026-07-23 — as três paralelas do épico terminaram. A fila volta à sequência: F04a → F04b → F06.
...
| [#23](https://github.com/RodReis/rrb-jarvisOS/issues/23) | 05 Identidades NOA e JARVIS | MVP-003 (#16) | `spec-design-system-05-identidades.md` | M3-F05 | [#46](https://github.com/RodReis/rrb-jarvisOS/pull/46) | *(aguardando)* |
...
| [#21](https://github.com/RodReis/rrb-jarvisOS/issues/21) | 04a AppShell + navegação | M3-F04a | `spec-design-system-04a-appshell-navegacao.md` | Backlog · **`next`** |
...
| [#24](https://github.com/RodReis/rrb-jarvisOS/issues/24) | 06 Adoção & hardening | M3-F06 | `spec-design-system-06-adocao-hardening.md` | Backlog |
...
| MVP-003 Design System da Plataforma (base única, 2 identidades) | [#16](https://github.com/RodReis/rrb-jarvisOS/issues/16) | **em andamento** desde 2026-07-23; F01, F02, F03a, F03b e F05 entregues, aguardando aceite; `next` na F04a (#21) | 0 / 8 *(5 entregues)* |
...
4. ~~**Code**: iniciar o MVP-003 pela F01 (#17)~~ — **feito** (2026-07-23): F01 no PR [#38](https://github.com/RodReis/rrb-jarvisOS/pull/38) e **F02 no PR [#40](https://github.com/RodReis/rrb-jarvisOS/pull/40)**, ambas no mesmo dia. Segue com WIP = 1, na ordem (F03a/F03b/F05) → F04a → F04b → F06. **F03a (#19)** no PR [#42](https://github.com/RodReis/rrb-jarvisOS/pull/42) e **F03b (#20)** no PR [#45](https://github.com/RodReis/rrb-jarvisOS/pull/45); **próxima: F05 (#23)**. A partir daqui as fatias são de UI: por decisão do PI (2026-07-23), a skill **impeccable** entra para construir, verificar e polir — sem substituir o piso de `dev`/`test`/`lint` verdes.
...
10. **PI**: aceitar as fatias entregues do MVP-003 — **F01 (#17)** PR [#38](https://github.com/RodReis/rrb-jarvisOS/pull/38), **F02 (#18)** PR [#40](https://github.com/RodReis/rrb-jarvisOS/pull/40), **F03a (#19)** PR [#42](https://github.com/RodReis/rrb-jarvisOS/pull/42), **F03b (#20)** PR [#45](https://github.com/RodReis/rrb-jarvisOS/pull/45) e **F05 (#23)** PR [#46](https://github.com/RodReis/rrb-jarvisOS/pull/46). Todas em `proplan:done`. O PI pediu (2026-07-23) para **fechar o MVP-003 inteiro antes de testar**, então o aceite pode vir em bloco no fim.
