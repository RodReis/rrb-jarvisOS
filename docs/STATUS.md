...
> **MVP-007 em detalhamento (2026-08-30).** Modelo de validação das lições fora da pipeline aprovado: critérios do módulo, evidência rastreável e automação sem aceite duplicado. Pipeline não depende da memória. Próxima decisão: contrato comum dos registros/eventos. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
...
5. MVP-007 em detalhamento, com modelo de validação das lições fora da pipeline aprovado; próxima decisão: contrato comum dos registros/eventos. Não há fatias ou SPECs aprovadas. MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F04 aprovados; F05–F06 aguardam redação nas #167–#168, que permanecem Planejadas.
