...
Atualizado em: **2026-09-03**. Fonte única do índice Fatia ↔ SPEC. Estado remoto conferido nesta revisão: o MVP-009 foi **finalizado e o épico #100 fechado** pelo PI. A **M25-F01 (#238), a M25-F02 (#239) e a M25-F03 (#240) foram entregues** — a jornada com etapa derivada, o prompt/refinamento/brief por IA, e o PRD/Landscape/Convention gerados com origem por afirmação; a cabeça da fila passa a ser a **M25-F04 (#241)** (`proplan:next`). Histórico detalhado em `docs/STATUS-ARQUIVO.md`; o board vence divergência factual.
...
| Backlog · `next` | [#241](https://github.com/RodReis/rrb-jarvisOS/issues/241) · M25-F04 Arquitetura por IA após os anexos | **cabeça da fila** desde a entrega da M25-F03. SPEC `aprovada-pi` (2026-09-03) |
| Backlog | [#242](https://github.com/RodReis/rrb-jarvisOS/issues/242) · M25-F05 Roadmap, MVPs e SPEC por IA | SPEC `aprovada-pi` em 2026-09-03; encadeada. Rota de assinatura obrigatória para toda geração |
...
| M25-F04 | MVP-025 | Arquitetura por IA após os anexos ([#241](https://github.com/RodReis/rrb-jarvisOS/issues/241)) | `spec-jornada-04-arquitetura-por-ia.md` — aprovada-pi; **next** |
