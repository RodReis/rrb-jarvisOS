...
> **MVP-007 em detalhamento (2026-08-30).** Ingestão/retomada por fonte aprovadas, com pendências rastreáveis e cobertura explícita. Graphify opcional e F05 focada; pipeline não depende da memória. Próxima decisão: contrato técnico opcional do Graphify. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
