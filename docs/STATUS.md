...
| Backlog · **next** | [#255](https://github.com/RodReis/rrb-jarvisOS/issues/255) · M26-F05 Modelo da fase no run | SPEC `aprovada-pi` (2026-09-04). `--model` da fase Construção no Claude Code do container; ledger |
