...
> **MVP-007 em detalhamento (2026-08-30).** PI aprovou memória compartilhada JarvisOS/AgentsOS, captura por eventos e identidade/correções. Graphify é opcional/substituível; F05 continua focada e a pipeline não depende da entrega da memória. Próxima decisão: persistência, retenção e reconstrução. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
...
5. MVP-007 em detalhamento, com captura e identidade/correções aprovadas; próxima decisão: persistência, retenção e reconstrução. Não há fatias ou SPECs aprovadas. MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F04 aprovados; F05–F06 aguardam redação nas #167–#168, que permanecem Planejadas.
