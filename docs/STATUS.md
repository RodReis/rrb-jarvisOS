...
> **MVP-007 em detalhamento (2026-08-30).** Direção, captura, identidade, persistência e recuperação seletiva aprovadas. Graphify opcional, orçamento do solicitante e F05 focada; pipeline não depende da memória. Próxima decisão: fontes iniciais e fronteira de integração. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
