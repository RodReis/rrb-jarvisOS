...
| MVP-007 Memória Contextual/RAG | — | direção compartilhada JarvisOS/AgentsOS aprovada (2026-08-30); design em elaboração; **sem fatias e sem SPEC** | — |
...
> **MVP-007 em detalhamento (2026-08-30).** Fontes iniciais por adaptadores de leitura aprovadas, além de captura, identidade, persistência e recuperação. Graphify opcional e F05 focada; pipeline não depende da memória. Próxima decisão: entrega e retomada da ingestão. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
...
5. MVP-007 em detalhamento, com fontes iniciais aprovadas; próxima decisão: entrega e retomada da ingestão. Não há fatias ou SPECs aprovadas. MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F04 aprovados; F05–F06 aguardam redação nas #167–#168, que permanecem Planejadas.
