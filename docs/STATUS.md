...
| Backlog | M7-F01–F05 (#180–#184), MVPs 010–015 e M16-F01–F04 | SPECs aprovadas; publicação documental não muda fila |
...
| Planejado | M7-F06 (#185) em revisão pelo PI; M7-F07–F08 (#186–#187) a redigir | Fora do fechamento da V3; redação não autoriza construção |
...
| MVP-007 Memória compartilhada | [#179](https://github.com/RodReis/rrb-jarvisOS/issues/179) | F01–F05 aprovadas/Backlog; F06 em revisão; F07–F08 Planejadas, fora do fechamento V3 | 0/8 |
...
| M7-F06 | MVP-007 | Memória operacional e validação de lições ([#185](https://github.com/RodReis/rrb-jarvisOS/issues/185)) | `spec-memoria-06-validacao-licoes-operacionais.md` — em revisão pelo PI |
...
4. M7-F05 está aprovada/Backlog, M7-F06 está em revisão pelo PI e M7-F07–F08 continuam a redigir; as fatias do Command Center seguem seus planejamentos próprios. Nenhuma delas bloqueia concluir a documentação V3.
