...
> **`proplan:next` = [#24](https://github.com/RodReis/rrb-jarvisOS/issues/24)** (MVP-003 · F06 Adoção & hardening). **7 das 8 fatias entregues** em 2026-07-23 — resta só a F06, que fecha o MVP.
...
| [#22](https://github.com/RodReis/rrb-jarvisOS/issues/22) | 04b Padrões operacionais | MVP-003 (#16) | `spec-design-system-04b-padroes-operacionais.md` | M3-F04b | [#50](https://github.com/RodReis/rrb-jarvisOS/pull/50) | *(aguardando)* |
...
| [#24](https://github.com/RodReis/rrb-jarvisOS/issues/24) | 06 Adoção & hardening | M3-F06 | `spec-design-system-06-adocao-hardening.md` | Backlog · **`next`** |
...
| MVP-003 Design System da Plataforma (base única, 2 identidades) | [#16](https://github.com/RodReis/rrb-jarvisOS/issues/16) | **em andamento** desde 2026-07-23; F01, F02, F03a, F03b, F05, F04a e F04b entregues, aguardando aceite; `next` na F06 (#24) | 0 / 8 *(7 entregues)* |
