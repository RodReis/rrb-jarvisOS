...
> **`proplan:next` = [#22](https://github.com/RodReis/rrb-jarvisOS/issues/22)** (MVP-003 · F04b Padrões operacionais). F01, F02, F03a, F03b, F05 e F04a entregues em 2026-07-23 — **6 das 8 fatias**. Resta: F04b → F06.
...
| [#21](https://github.com/RodReis/rrb-jarvisOS/issues/21) | 04a AppShell + navegação | MVP-003 (#16) | `spec-design-system-04a-appshell-navegacao.md` | M3-F04a | [#49](https://github.com/RodReis/rrb-jarvisOS/pull/49) | *(aguardando)* |
...
| [#22](https://github.com/RodReis/rrb-jarvisOS/issues/22) | 04b Padrões operacionais | M3-F04b | `spec-design-system-04b-padroes-operacionais.md` | Backlog · **`next`** |
...
| MVP-003 Design System da Plataforma (base única, 2 identidades) | [#16](https://github.com/RodReis/rrb-jarvisOS/issues/16) | **em andamento** desde 2026-07-23; F01, F02, F03a, F03b, F05 e F04a entregues, aguardando aceite; `next` na F04b (#22) | 0 / 8 *(6 entregues)* |
