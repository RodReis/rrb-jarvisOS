...
Atualizado em: **2026-09-03**. Fonte única do índice Fatia ↔ SPEC. Estado remoto conferido nesta revisão: o MVP-009 foi **finalizado e o épico #100 fechado** pelo PI. A **M25-F01 (#238), a M25-F02 (#239), a M25-F03 (#240) e a M25-F04 (#241) foram entregues** — a jornada com etapa derivada, o prompt/refinamento/brief por IA, o PRD/Landscape/Convention gerados com origem por afirmação, e a arquitetura gerada com âncora no protótipo; a cabeça da fila passa a ser a **M25-F05 (#242)** (`proplan:next`). Histórico detalhado em `docs/STATUS-ARQUIVO.md`; o board vence divergência factual.
...
| Backlog · `next` | [#242](https://github.com/RodReis/rrb-jarvisOS/issues/242) · M25-F05 Roadmap, MVPs e SPEC por IA | **cabeça da fila** desde a entrega da M25-F04. SPEC `aprovada-pi` em 2026-09-03. Rota de assinatura obrigatória para toda geração |
...
| MVP-025 Jornada de planejamento por IA | [#237](https://github.com/RodReis/rrb-jarvisOS/issues/237) | criado em 2026-09-03; corrige o fluxo inicial do MVP-008 (prompt, refinamento e geração por IA, jornada única). Cinco SPECs `aprovada-pi`; M25-F01 a F04 entregues; #242 `next`; doc em `docs/mvp/mvp-025-jornada-planejamento-ia.md` | 4/5 |
...
| M25-F05 | MVP-025 | Roadmap, MVPs e SPEC por IA ([#242](https://github.com/RodReis/rrb-jarvisOS/issues/242)) | `spec-jornada-05-roadmap-mvp-spec-por-ia.md` — aprovada-pi; **next** |
