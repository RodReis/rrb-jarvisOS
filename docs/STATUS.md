...
| Backlog · **next** | [#253](https://github.com/RodReis/rrb-jarvisOS/issues/253) · M26-F03 Console da geração | SPEC `aprovada-pi` (2026-09-04). Trace persistido por geração, `stream-json`, painel retrátil na etapa |
...
1. **[#251](https://github.com/RodReis/rrb-jarvisOS/issues/251) (M26-F01) e [#252](https://github.com/RodReis/rrb-jarvisOS/issues/252) (M26-F02) entregues** e em `proplan:done` desde 2026-09-04 — fechamento e `proplan:finalizado` são atos do PI. A cabeça da fila é [#253](https://github.com/RodReis/rrb-jarvisOS/issues/253) (M26-F03, `proplan:next`). Ordem do MVP-026: F01 → F02 → F03 → F04 → F05 → M10-F02 ([#117](https://github.com/RodReis/rrb-jarvisOS/issues/117)) → F06 ([#256](https://github.com/RodReis/rrb-jarvisOS/issues/256)). Todas em Backlog. MVP-025: filhas `proplan:finalizado`; fechamento do épico #237 é ato do PI. MVP-022 e Command Center vêm depois do MVP-026.
