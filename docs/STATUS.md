...
13. **PI — decidir sobre o `VoiceMascot`** (apontado no #57): o protótipo desenha o mascote do login a **112px**; o DS oferece `medio` (96px) e `grande` (160px), e o `grande` não é usado por nenhuma tela do app. Ajustá-lo para 112px alinharia o DS ao protótipo sem quebrar consumidor algum — mas é mudança no design system, não no consumidor.
