...
| MVP-016 Aprendizado Operacional da Pipeline | [#162](https://github.com/RodReis/rrb-jarvisOS/issues/162) | F01–F02 #163–#164 em Backlog; F03–F06 #165–#168 Planejadas, SPECs a redigir | 0/6 |
...
> **MVP-016 em especificação (2026-08-29).** M16-F01–F02 (#163–#164) estão `aprovada-pi`, em Backlog; F03–F06 (#165–#168) aguardam redação. A F06 mantém gate visual. Fonte: `docs/superpowers/specs/2026-08-29-mvp-016-aprendizado-operacional-design.md`.
...
5. MVP-007 e MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F02 aprovados; F03–F06 aguardam redação nas issues #165–#168, que permanecem Planejadas.
...
9. **Pipeline V3 publicada:** épicos #149/#155/#162 e 17 fatias, com parents e dependências reconciliados. Próxima especificação: M16-F03 na #165; M15-F05 (#160) e M16-F06 (#168) mantêm `DESIGN-SYSTEM.md` e protótipos HTML antes da construção.
