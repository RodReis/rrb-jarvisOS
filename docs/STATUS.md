...
> **MVP-007 em detalhamento (2026-08-30).** Contrato comum dos registros/eventos aprovado. Issues ainda não criadas, conforme conferência no GitHub; próxima decisão: organizar fatias e publicação do acompanhamento. Pipeline não depende da memória. Fonte: `docs/superpowers/specs/2026-08-30-mvp-007-memoria-compartilhada-design.md`.
...
5. MVP-007 com contrato comum dos registros/eventos aprovado, mas sem issues criadas (GitHub conferido em 2026-08-30). Próxima decisão: organizar fatias e publicar o acompanhamento; não há fatias ou SPECs aprovadas. MVP-017–MVP-018 ainda serão detalhados. O MVP-016 possui design, seis fatias e M16-F01–F04 aprovados; F05–F06 aguardam redação nas #167–#168, que permanecem Planejadas.
