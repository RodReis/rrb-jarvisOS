...
4. M16-F05 mantém escopo focado e integração reutilizável; MVP-016 mantém validação operacional já aprovada e não depende obrigatoriamente do MVP-007. O catálogo de captura e a validação de lições dos demais módulos ainda serão especificados.
