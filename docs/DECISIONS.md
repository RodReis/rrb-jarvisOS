...
26. O MVP-016 foi decomposto em seis fatias aprovadas. M16-F01–F03 receberam `aprovada-pi`; F04 em `revisão-pi` desde 2026-08-30; F05–F06 aguardam redação. Épico #162 publicado; #163–#165 em backlog e #166–#168 planejadas. A F06 mantém gate visual. MVP-017–MVP-018 mantêm somente direção aprovada.
