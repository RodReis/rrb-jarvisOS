...
26. O MVP-016 foi decomposto em seis fatias aprovadas. A M16-F01 recebeu `aprovada-pi`; F02 está `revisão-pi`; F03–F06 aguardam redação. Épico #162 publicado; #163 em backlog e #164–#168 planejadas. A F06 mantém gate visual. MVP-017–MVP-018 mantêm somente direção aprovada.
