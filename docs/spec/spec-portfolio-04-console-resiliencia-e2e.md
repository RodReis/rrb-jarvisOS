...
- Implementação: não iniciada; o aceite habilita o Backlog, sem alterar `next` ou a fila. Antes da construção do console, anexar e aprovar `DESIGN-SYSTEM.md` e protótipos HTML formais.
