...
- **Emenda 2026-08-29 (PI, revisões dos MVPs 008/010):** o gate de USD vale **somente para rota paga** (API/BYOK). A rota de assinatura é `subscription_limited`: não tem preço USD por chamada, mas possui quota; o ledger registra chamadas, tokens, tempo, estado de quota e reset quando observável. Converter assinatura em USD estimado foi descartado. Crédito monetário adicional usa ledger/teto próprio e nunca é consumido silenciosamente. Créditos de conector continuam no ledger da SPEC-Conectores-02.
