...
- Fatias: oito recortes de planejamento, com publicação autorizada pelo PI em 2026-08-30; SPECs da F01–F02 aprovadas, F03 em rascunho para revisão, F04–F08 a redigir. Permanece a orientação de não implementar agora. Índice canônico: `docs/STATUS.md`.
...
O plano de publicação está em `docs/superpowers/plans/2026-08-30-mvp-007-publicacao-issues.md`, com escopo, dependências, alvos de verificação e pendências por fatia. Numeração e associação às SPECs permanecem no índice canônico de `docs/STATUS.md`; F01–F02 estão **aprovadas-pi**, F03 em **rascunho para revisão**, F04–F08 estão **a redigir**.

Rascunho da F03: `docs/spec/spec-memoria-03-recuperacao-contextual-orcamento.md`. Propõe busca lexical local e relações opcionais, consultas históricas e validade/cobertura explícitas, sessões/expansões limitadas, parcela de orçamento e integração opcional com ContextPack/envio. Vinte critérios propostos; nenhuma alteração técnica nos contratos aprovados F01/F02. #182 permanece Planejada, dependente de #181.
...
1. Revisão/aceite do rascunho da F03 (#182); redação, critérios finais e aprovação de F04–F08. F01–F02 aprovadas pelas revisões exatas acima, sem repetir seus aceites.
...
4. Aprovação dos contratos de consulta/resultados, atualização do índice, limites e ponte com ContextPack propostos na F03 conforme a seção 9.
