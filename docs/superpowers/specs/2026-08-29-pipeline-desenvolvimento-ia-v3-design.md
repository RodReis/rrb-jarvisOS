...
- Status: **direção da V3, designs dos MVPs 014–016, onze SPECs dos MVPs 014–015 e M16-F01–F03 aprovados pelo PI** em 2026-08-29.
...
O MVP-014 está detalhado neste documento. O MVP-015 possui design e seis SPECs aprovadas em `2026-08-29-mvp-015-observabilidade-operacional-design.md`. O MVP-016 possui design e seis fatias aprovadas em `2026-08-29-mvp-016-aprendizado-operacional-design.md`; M16-F01–F03 estão `aprovada-pi`, F04 em `revisão-pi` desde 2026-08-30 e F05–F06 aguardam redação. MVP-017 e MVP-018 mantêm somente direção aprovada.
...
Este design autoriza as cinco SPECs do MVP-014 e remete os MVPs 015–016 aos seus designs complementares aprovados. Não autoriza implementação, gasto novo, push ou PR. A publicação das issues dos MVPs 014–016 foi autorizada separadamente pelo PI e concluída em 2026-08-29. Quatorze SPECs aprovadas estão em backlog; as três fatias restantes do MVP-016 permanecem planejadas.
